...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference('Resource.count') do
      post resources_url, params: { resource: { description: @resource.description, link: @resource.link, title: @resource.title } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { description: @resource.description, link: @resource.link, title: @resource.title } }
